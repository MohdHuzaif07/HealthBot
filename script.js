...
const messages = [{ role: "system", content: "you are mental health friend listen and kindly response with less than 100 words note: don't your ever repeat the same sentence again " }];
...
function createMessageBox(datas, classname) {
    ...
    messageConsole.prepend(messagebox);
